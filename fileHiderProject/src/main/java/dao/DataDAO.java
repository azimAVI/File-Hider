...
public class DataDAO {
    ...
    public static void unhide(int id) throws SQLException, IOException{  // if file exists then we can hide it
        Connection connection = MyConnection.getConnection();
        ...
        Clob c = rs.getClob("bin_data"); // Character Large object
